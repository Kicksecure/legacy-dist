...
NOTE: Replace `generic-package` with the actual name of this package `legacy-dist`.
...
`legacy-dist` requires [donations](https://www.kicksecure.com/wiki/Donate) to stay alive!
